...
class Field {
  ...
  bool operator ==(Object other) => identical(this, other) || other is Field &&
    ...
    other.action == action &&
    other.icon == icon &&
    other.showIconOnly == showIconOnly &&
  ...
  int get hashCode =>
    ...
    (showIconOnly == null ? 0 : showIconOnly!.hashCode) +
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.showIconOnly != null) {
      json[r'showIconOnly'] = this.showIconOnly;
    } else {
      json[r'showIconOnly'] = null;
    }
    ...
    if (this.readWrite != null) {
      json[r'readWrite'] = this.readWrite;
    } else {
      json[r'readWrite'] = null;
    }
    if (this.writeOnly != null) {
      json[r'writeOnly'] = this.writeOnly;
    } else {
      json[r'writeOnly'] = null;
    }
    return json;
  }
  ...
  static Field? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Field(
        ...
        action: ActionRef.fromJson(json[r'action']),
        icon: mapValueOfType<String>(json, r'icon'),
        showIconOnly: mapValueOfType<bool>(json, r'showIconOnly'),
        ...
        readWrite: mapValueOfType<bool>(json, r'readWrite'),
        writeOnly: mapValueOfType<bool>(json, r'writeOnly'),
      );
    }
    return null;
  }
