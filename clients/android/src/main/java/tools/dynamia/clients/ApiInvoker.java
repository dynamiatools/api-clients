...
import tools.dynamia.clients.auth.Authentication;
import tools.dynamia.clients.auth.ApiKeyAuth;
import tools.dynamia.clients.auth.HttpBasicAuth;
import tools.dynamia.clients.request.GetRequest;
import tools.dynamia.clients.request.PostRequest;
import tools.dynamia.clients.request.PutRequest;
import tools.dynamia.clients.request.DeleteRequest;
import tools.dynamia.clients.request.PatchRequest;
...
public class ApiInvoker {
  ...
  */
  ...
  public static void initializeInstance(Cache cache, Network network, int threadPoolSize, ResponseDelivery delivery, int connectionTimeout) {
    ...
    setUserAgent("OpenAPI-Generator/5.3.7/android");
